...
class ThreeCard extends StatefulWidget {
  List indexValue = [];
   ThreeCard({Key? key, required this.indexValue}) : super(key: key);
  @override
...
class _ThreeCardState extends State<ThreeCard> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        ...
        appBar: TitleBar().appBar('Three-Card Spread', context),
                      ...
                      Flexible(
                        child: Row(
                          ...
                          children: [
                                              ...
                                              () {
                                                Route route = MaterialPageRoute(
                                                  builder:
                                                    ...
                                                    data: oneCard,
                                                    titleData:
                                                    StaticData.threeCardSpreads[0][0],
                            ...
                            SizedBox(width: Responsible.width * 0.03),
                            twoCard != null
                                ? InkWell(
                                    onTap: () {
                                      showCard != false
                                              ...
                                              Route route = MaterialPageRoute(
                                                builder:
                                                    (BuildContext context) =>
                                                        ShowData(
                                                  data: twoCard,
                                                  titleData: StaticData.threeCardSpreads[1]
                                                      [0],
                                                          cardsIndex: getIndexValue!, ),
                                              );
                                              Navigator.push(context, route);
                            ...
                            threeCard != null
                                ? InkWell(
                                              ...
                                              Route route = MaterialPageRoute(
                                                builder:
                                                    (BuildContext context) =>
                                                        ShowData(
                                                  data: threeCard,
                                                  titleData: StaticData.threeCardSpreads[2]
                                                      [0],
                                                          cardsIndex: getIndexValue!,  ),
                                              );
                                              Navigator.push(context, route);
                                    ...
                                    child: cards(
                                        context, height, width, threeCard![0]),
                                  )
                                : sampleContent(context, height, width),
                          ],
                        ),
